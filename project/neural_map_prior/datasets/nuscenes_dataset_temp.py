...
class nuScenesMapDataset(BaseMapDataset):
    ...
    def load_annotations(self, ann_file):
        ...
        #         new_data_infos = []
        #         new_data_city = []
        #         data_city_names_train = load_data_infos('train', only_city=True)
        #         data_city_names_val = load_data_infos('val', only_city=True)
        ...
        #                 new_data_infos.append(deepcopy(info))
        #                 new_data_city.append(city_name)
        #         data_infos = new_data_infos
        #         data_city_names = new_data_city
        #
        #         print('new_data_infos', len(data_infos))
        #         print('new_data_city', len(data_city_names))
        #
        # if 'infos_val' in ann_file:
        #     if hasattr(self, 'nusc_city_split') and self.nusc_city_split:
        #         new_data_infos = []
        #         new_data_city = []
        #         data_city_names_train = load_data_infos('train', only_city=True)
